 ...
 */
typedef void (* http_callback)(char * response_body, int http_status, char * response_headers);
 ...
 * Output on the UART.
 */
void http_callback_example(char * response, int http_status, char * response_headers);
